import { AvengersInterface } from './avengers.interface';
// Tipar la constante con la interfaz que créeis en una archivo avengers.models.ts

export const avengersData: AvengersInterface[] = [
  {
    hero: 'Spider-Man',
