...
const alienCucushumushu = aliens.filter(element => element.name.includes('Cucushumushu'))
const mutationPoro = mutations.filter(element => element.name.includes('Porompompero'))

alienCucushumushu.mutation = mutationPoro
