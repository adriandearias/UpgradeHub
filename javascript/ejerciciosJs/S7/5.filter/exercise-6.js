...
const newStreamersLol = streamers.filter(streamer => streamer.gameMorePlayed.includes('Legends'))
newStreamersLol.map(streamer=> streamer.age > 35 ? streamer.gameMorePlayed = streamer.gameMorePlayed.toUpperCase() : '' )

console.log(newStreamersLol)